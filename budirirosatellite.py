...
def predict_risk():
    ...
    def calc_risk():
        ...
        if points <= 2:
            ...
            category = "HIGH RISK"
            action = "Weekly visits + Home support"
        return points, risk, category, action, factors

    if st.button("🔍 Calculate Risk", type="primary"):
        points, risk, category, action, factors = calc_risk()
        ...
        st.markdown("**Risk Factors:** " + ", ".join(factors))
